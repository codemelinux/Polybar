...
conky -c ~/.config/conky/Conky/rings & # the main conky with rings
...
conky -c ~/.config/conky/Conky/cpu &
sleep 1
conky -c ~/.config/conky/Conky/mem &
conky -c ~/.config/conky/Conky/notes &
